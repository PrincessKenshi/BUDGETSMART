...
?>
    <div class="wrapper" style="background-color:#A7EBC2;">
        <div class="row">
            <div class="col-4 col-m-4 col-sm-4">
                <div class="card" style="background-color:#AB99C4;">
                    <div class="counter bg-danger" style="color:white;background-color:#AB99C4;">
            ...
            <div class="col-4 col-m-4 col-sm-4">
                <div class="card">
                    <div class="counter bg-primary" style="color:white;background-color:#AB99C4;">
            ...
            <div class="col-4 col-m-4 col-sm-4">
                <div class="card">
                    <div class="counter bg-warning" style="color:white;background-color:#AB99C4;">
            ...
            <div class="col-4 col-m-4 col-sm-4">
                <div class="card">
                    <div class="counter bg-vio" style="color:white;background-color:#AB99C4;">
            ...
            <div class="col-4 col-m-4 col-sm-4">
                <div class="card">
                    <div class="counter bg-success" style="color:white;background-color:#AB99C4;">
            ...
            <div class="col-4 col-m-4 col-sm-4">
                <div class="card">
                    <div class="counter bg-yell" style="color:white;background-color:#AB99C4;">
