...
<div class="wrapper" style="background-color:#A7EBC2;">
    <div class="row">
        <div class="col-12 col-m-12 col-sm-12" >
            <div class="card">
                <div class="counter" style="display: flex; align-items: center; justify-content: center; background-color: #AB99C4;color:#3C2B52;">
                ...
                <form action="">
                    ...
                    <div><br>
                        <a href="11-changepass.php"><button type="button" class="pressbutton" name="submit" style="background-color:#3C2B52;">Change Password</button></a>
                    </div>								
