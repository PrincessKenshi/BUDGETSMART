...
<div class="wrapper" style="background-color:#A7EBC2;">
        <div class="row">
            <div class="col-12 col-m-12 col-sm-12" >
                <div class="card">
                    <div class="counter"  style="height: 40vh; display: flex; align-items: center; justify-content: center; background-color: #AB99C4;">
                        <form action="" method="post"> 
                                ...
                                <button type="submit" name="enterbudget" class="pressbutton" style="background-color:#3C2B52;">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
