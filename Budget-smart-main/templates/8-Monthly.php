...
<div class="wrapper" style="background-color:#A7EBC2;">
    <div class="row">
        <div class="col-12 col-m-12 col-sm-12" >
            <div class="card">
                <div class="counter" style="display: flex; align-items: center; justify-content: center;background-color: #AB99C4;">
                ...
                <form action="8-Monthly-Detailed.php" method="post" id="mthform" onsubmit = "return validate()">
                    <h1 style="display: block; font-family: 'Source Sans Pro'">Monthwise Expense Report</h1>
                        ...
                        <div><br>
                        <button type="submit" class="pressbutton" name="mthsubmit" style="background-color:#3C2B52;">Submit</button>
                        </div>								                            
                </form>
