...
<div class="wrapper" style="background-color:#A7EBC2;">
        <div class="row">
            <div class="col-12 col-m-12 col-sm-12" >
                <div class="card">
                    <div class="counter" style="height: 60vh; display: flex; align-items: center; justify-content: center;background-color: #AB99C4;">
                    <form action="" method="post">
								...
								<div><br>
									<button type="submit" class="pressbutton" name="addexpense" style="background-color:#3C2B52;">Add</button>
								</div>								
