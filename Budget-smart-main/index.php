...
<head>
    ...
    <link rel="icon" href="static/images/budgetsmart_logo.png" sizes="30x35" type="image/png">
...
<body>
    <div class="body" style="background-color: #7066A6;">
        <div class="container" style="background-color:#A5EFC2;">
            ...
            <div class="top-heading">
                <h1 style="color:#542D69;">Budget Smart</h1>
                <h3 style="color:#542D69;margin-left:150px;margin-top:20px;">Always Budget Smart!</h3>
            </div>
            <form action="index.php" method="post" onsubmit = "return validate()" id="form1">
                ...
                <div class="group">
                    ...
                    <div class="form-controller">
                        <i class="fa fa-user-plus u3" aria-hidden="true" style="color:#7066A6;"></i>
                        <input type="text" name="username" placeholder="School ID" id="user1" required>
                        <br>
                        <small></small>
                    </div>

                    <div class="form-controller">
                        <i class="fa fa-key u4" aria-hidden="true" style="color:#7066A6;"></i>
                ...
                <button type="submit" class="sign-in" name="login" style="background-color:#7066A6;">Log In</button>
            ...
            <div class="img-container">
                <img src="static/images/budgetsmart_logo.png" alt="Login-screen-picture">
            </div>
        </div>
    </div>
